...
Next script \path{message-extractor.py} works with the bytes stored in the SQLite database, the column \emph{data} and table \emph{messages} in particular. Those bytes store information on one single message sent in a regular chat.
