...
Today, many social networks as well provide some form of messaging solution and the users are picky. Instant messengers are de facto required to have both mobile and web access and more advance capabilities, such as media, voice, or location sharing and the list goes on.

The surveillance disclosures emanating from the ex-NSA employee Edward Snowden showed the demand for a secure communication and a number of solutions has emerged. The~more users share the more we realize the pitfalls of insecure communication.
