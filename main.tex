...
The findings were reported to Telegram security team on 7 December 2016 with a request for comments. In particular, two points were discussed, the obfuscation method and the Replay attack scenario. A response from Telegram was received on 12 December 2016.

The obfuscation method was commented only briefly as \emph{``unrelated to data security and is used to counter some of the less sophisticated attempts at banning our service in certain countries''}. In October 2015 Pavel Durov stated on its Twitter account that Telegram was blocked temporarily in Iran as a result of denied collaboration with the Iranian government~\cite{telegram-durov-iran}. This of course concerns other countries applying some form of internet censorship but illustrates that Telegram indeed faces censorship issues.
...
Under these circumstances it is understandable why the obfuscation method is not documented.

Secondly, Telegram responded to our attack scenario from Section \ref{analysis-attacks}.
