...
The human interaction and communication takes place more and more often in the digital world. This trend will most likely continue and the line between real and digital may one day disappear entirely. The surveillance disclosures emanating from the ex-NSA employee Edward Snowden showed the demand for a secure communication and number of solutions emerged\footnote{Málo "akademické"? Na druhou stranu se po Snowdenovi výrazně více začala řešit bezpečnost komunikace.}. The more users share the more we realize the pitfalls of insecure communications.

In the scope of this thesis I aim\footnote{První osoba je v pořádku v úvodu?} to provide a brief overview of the current Instant Messenger solutions with the focus on their security. Following this summary I'll focus into more depth on Telegram. Telegram introduces its own cryptographic protocol MTProto instead of using known solutions. Many of the cryptographic community raised its concerns on this decision\footnote{Moc silné tvrzení na úvod?}. I'll be devoted to its further investigation, studying the cryptography behind the protocol, how the protocol deals with key negotiation, message authentication, integrity and other.
