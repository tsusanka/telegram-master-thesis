...
\section{Attack scenario}\label{analysis-attacks}
...
If Telegram does not provide any additional checks and actually deletes the first ID the message would be accepted twice. With the attack scenario drafted it is obviously desired to perform the attack.

\subsection{Replay attack attempt}
