...
\begin{figure}[htb]
	...
	\caption[WhatsApp's registration process]{WhatsApp's registration process prompts the user to enter its phone number and verifies it by sending a text message.}
...
On May 2012 an application called ``WhatsAppSniffer'' had been released ~\cite{whatsapp-sniffer, whatsapp-sniffer2}. It abused described flaw and enabled attacker to see victim's messages in easy and lucid user interface.

\begin{figure}[htb]
	\centering
	\includegraphics[width=0.4\textwidth]{whatsapp-sniffer.png}
	\caption[WhatsAppSniffer]{WhatsAppSniffer application was able to sniff all user's data and read them~\cite{whatsapp-sniffer2}.}
