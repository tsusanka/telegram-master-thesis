...
\begin{figure}[htb]
	...
	\caption{Payload of a single message \cite{telegram-aarhus} in secret chat.}
...
\begin{itemize}
	...
	\item  \textbf{serialized message object} Containing other values and the message itself as depicted in Figure \ref{img:decrypted-message}.
\end{itemize}
...
The cornerstone of the payload is the \textbf{decryptedMessage} object depicted in Figure \ref{img:decrypted-message} which contains:
